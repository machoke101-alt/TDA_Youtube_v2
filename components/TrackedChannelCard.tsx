            ...
            <div className="p-4 flex flex-col items-center text-center flex-grow">
                ...
                <div className="my-2 text-center">
                    ...
                    {channel.lastRefreshedAt && (
                        ...
                        >
                            ...
                            <span className="tabular-nums">{formatRelativeTime(new Date(channel.lastRefreshedAt).toISOString())}</span>
                        </div>
                    )}
                </div>
                ...
                <div className="flex justify-around w-full mt-auto text-sm">
                    <div className="text-center">
                        <p className="font-bold text-white tabular-nums">{formatNumber(channel.subscriberCount)}</p>
                        <p className="text-xs text-gray-400">Subs</p>
                    </div>
                    <div className="text-center">
                        <p className="font-bold text-white tabular-nums">{formatNumber(channel.videoCount)}</p>
